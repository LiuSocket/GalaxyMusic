...
namespace GM
{
	...
	*/
	...
	public:
		...
		* @return void
		*/
		void MakeNebula(double fLength = 1e21, double fWidth = 1e21, double fHeight = 5e19
	...
	protected:
		...
		*/
		osg::Geometry* MakeSphereGeometry(float fRadius = 10.0f, int iLatSegment = 32);
		...
		* @return Geometry			返回创建的几何体指针
		*/
		osg::Geometry* MakeBoxGeometry(float fLength = 10.0f, float fWidth = 10.0f, float fHeight = 2.0f);
	...
	protected:
		...
		osg::ref_ptr<osg::Texture>							m_3DErosionTex;					//!< 小尺寸三维无缝噪声，32^3
	...
	private:
		...
		osg::ref_ptr<osg::Texture2D>						m_distanceMap;					//!< the 1/16 size distance texture by ray march
