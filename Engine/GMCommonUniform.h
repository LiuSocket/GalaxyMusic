	...
	*/
	...
	public:
		...
		*/
		...
		inline osg::Uniform*const GetStarColor() const { return m_vStarColorUniform.get(); }
		inline void SetStarColor(const osg::Vec4f vColor) { m_vStarColorUniform->set(vColor); }

		inline osg::Uniform*const GetLevelArray() const { return m_fLevelArrayUniform.get(); }
		...
		*/
		...
		inline osg::Uniform* const GetUnit() const { return m_fUnitUniform.get(); }

		inline osg::Uniform*const GetStarHiePos() const { return m_vStarHiePosUniform.get(); }
		inline void SetStarHiePos(const osg::Vec3f v) { m_vStarHiePosUniform->set(v); }
